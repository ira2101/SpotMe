...
public class UsersRepository {
    ...
    public int insertBooking(Bookings booking) {
        return jdbcTemplate.update(
            "insert into Bookings (email, location, start_time, end_time, parking_date) values(?,?,?,?,?)",
            booking.getEmail(), booking.getLocation(), booking.getStart_time(), booking.getEnd_time(), booking.getParking_date());          
    }
