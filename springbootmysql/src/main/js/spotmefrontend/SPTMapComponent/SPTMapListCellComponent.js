...
class SPTMapListCelComponent extends Component {
  ...
  render = () => {
    ...
    return (
      <TouchableOpacity style={{ flexDirection: "row", marginLeft: 2 }} onPress={()=>{this.props.navigator.navigate('Navigator'); parkingname = this.props.spotInfo.parking_name; price = this.props.spotInfo.price}}> 
        <Image
          style={styles.image}
