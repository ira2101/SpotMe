...
//   const [confirm, setConfirm] = useState('');
  ...
  function del(email) {
    fetch(localhost + '/users/deleteAccount/' + email, {
        method: 'DELETE',
        headers : {
...
function remove(email, name) {
  fetch(localhost + '/users/deleteLocation/' + email + '/' + name, {
      method: 'DELETE',
      headers : {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.loginButton}>
          <Text style={styles.loginButtonWord} onPress= {() => del(email)}>DELETE</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.loginButton}>
          <Text style={styles.loginButtonWord} onPress= {() => remove(emailparking,name)}>REMOVE</Text>
        </TouchableOpacity>
      </View>
      </ScrollView>
    </SafeAreaView>
